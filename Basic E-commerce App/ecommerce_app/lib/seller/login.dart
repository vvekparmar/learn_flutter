...
import 'package:ecommerce_app/seller/signup.dart';
import 'package:ecommerce_app/seller/addItem.dart';
import 'package:ecommerce_app/seller/getEmail.dart';
                      ...
                      children: [
                        Container(
                          ...
                          child: FlatButton(
                            ...
                            onPressed:() async{
                                List data;
                                CollectionReference collectionReference = Firestore.instance.collection('Seller_Data');
