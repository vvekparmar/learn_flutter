...
import 'package:ecommerce_app/seller/addItem.dart';

class SellerSignOutPage extends StatefulWidget {
  @override
  _SellerSignOutPageState createState() => _SellerSignOutPageState();
}

class _SellerSignOutPageState extends State<SellerSignOutPage> {
                  ...
                  children: [
                    Container(
                      ...
                      child: FlatButton(
                        ...
                        child: Text("Add Another Item",style: TextStyle(fontWeight:FontWeight.bold,fontSize: 20)),
                        onPressed: (){
                          Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => AddItem()));
                        },
                      ),
                    ),
                    SizedBox(height: 20),
